 ...
 */
public class AdvertiserThreeService extends Service {

    private static final String TAG = AdvertiserThreeService.class.getSimpleName();
        ...
        if (mBluetoothLeAdvertiser == null) {
            ...
            if (mBluetoothManager != null) {
                ...
                if (mBluetoothAdapter != null) {
                    ...
                    Toast.makeText(AdvertiserThreeService.this, "null", Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(AdvertiserThreeService.this, "null", Toast.LENGTH_LONG).show();
            }
    ...
    private void startAdvertising() {
        ...
        //Toast.makeText(AdvertiserThreeService.this, "Start AdvertiserService", Toast.LENGTH_LONG).show();
    }
    ...
    private void stopAdvertising() {
        ...
        //Toast.makeText(AdvertiserThreeService.this, "Stop AdvertiserService", Toast.LENGTH_LONG).show();
    }
